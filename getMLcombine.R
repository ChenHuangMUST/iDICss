...
#' 
#' A function that develops robust predictive models with excellent performance, using patient prognosis as the outcome.
#' 
...
#'
#' @examples
getMLcombine = function(train_data, # cohort data used for training, the colnames of which inlcuding ID, OS.time, OS, and the other candidate genes
